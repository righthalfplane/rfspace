...
class osmo_nfm_rx(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "OSMOSDR NFM RX")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("OSMOSDR NFM RX")
        ...
        self.settings = Qt.QSettings("GNU Radio", "osmo_nfm_rx")
    ...
    def set_s_rate(self, s_rate):
        self.s_rate = s_rate
        self.qtgui_freq_sink_x_0.set_frequency_range(self.freq, self.s_rate)
        self.qtgui_freq_sink_x_1.set_frequency_range(self.freq, self.s_rate)
...
def main(top_block_cls=osmo_nfm_rx, options=None):
